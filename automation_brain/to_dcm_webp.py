...
# Opening JSON file
f = open('automation_brain/mri/meta.json')
...
webp_files = glob.glob('automation_brain/mri/*.webp')
...
for i in range (n):
    webp_paths.append('automation_brain/mri/mri_'+ str(i) +'.webp')
...
ds.save_as('automation_brain/mri/mri_res.dcm')