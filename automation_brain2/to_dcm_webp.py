...
# Opening JSON file
f = open('automation_brain2/mri/meta.json')
...
webp_files = glob.glob('automation_brain2/mri/*.webp')
...
for i in range (n):
    webp_paths.append('automation_brain2/mri/mri_'+ str(i) +'.webp')
...
ds.save_as('automation_brain2/mri/mri_res.dcm')